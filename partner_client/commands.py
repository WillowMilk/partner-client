...
class CommandRouter:
    def __init__(self, config: Config, session: Session, tools: ToolRegistry):
        ...
        self._commands: dict[str, tuple[str, CommandHandler]] = {
            ...
            "/sail": ("The sail: save + archive this session; the next launch rises fresh (on her curated floor, if she chose one).", self._cmd_sleep),
            "/sleep": ("Quiet alias for /sail (the rite was renamed 2026-08-22 — a departure, not a death).", self._cmd_sleep),
